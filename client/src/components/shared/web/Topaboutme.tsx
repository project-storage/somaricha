  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundColor: "#8C6E63", height: 465, margin: 0 ,boxShadow: "0px 13px 19px 0px rgba(0,0,0,0.25)",}}
      >
        ...
        <div className="flex justify-center items-center mb-4 gap-6">
          <h1 className="text-[55px] font-bold">เกี่ยวกับเรา</h1>
          <h1 className="text-[55px] font-bold">About us</h1>
        </div>


        {/* คำอธิบาย */}
        <p className='text-[28px] max-w-3xl mx-auto'>
        ...
        {/* ปุ่ม */}
        <div className='mt-8'>
          <button className="round-btn" style={{ width: 213 }}>About us</button>
        </div>
      </div>
